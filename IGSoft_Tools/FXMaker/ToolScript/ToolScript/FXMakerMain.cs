...
// 			NgAssembly.GetPropertis(FXMakerHierarchy.inst.GetSelectedGameObject().renderer);
	...
	public void OnGUIStart()
	{
		...
		// Menu Change UI ------------------------------------------------------
		GUI.skin = m_GuiMainEngSkin;
		AutoFocusWindow(FXMakerLayout.GetWindowId(FXMakerLayout.WINDOWID.TOP_LEFT), FXMakerLayout.GetMenuChangeRect(), winMenuChange, "FX Maker " + FXMakerLayout.m_CurrentVersion);
