...
public class FXMakerLayout : NgLayout
{
	...
	public		const string	m_CurrentVersion			= "v1.22";
	...
	public		static float	GetTopMenuHeight()			{ if (m_fTopMenuHeight < 0) m_fTopMenuHeight = (m_bMinimizeAll||m_bMinimizeTopMenu ? m_MinimizeHeight : UnityEditor.EditorPrefs.GetFloat("FXMakerOption.m_fTopMenuHeight", 92)); return m_fTopMenuHeight; }
#else
